...
RELATED_PATH_MASTER = '/master'
RELATED_PATH_META_REGION = '/meta-region-server'
...
class Connection(object):
    ...
    def __init__(self, on_close, zkquorum, zk_znode_parent):
        """Connection.
        ...
        self._zk_master_path = zk_znode_parent + RELATED_PATH_MASTER
        self._zk_meta_region_path = zk_znode_parent + RELATED_PATH_META_REGION

        self._client = client.Client(zkquorum, self._zk_master_path, self._zk_meta_region_path)
...
class ConnectionPool(object):
    ...
    def __init__(self, zkquorum, zk_znode_parent, max_size=10):
        """Connection pool.
        ...
        """
        self._zkquorum = zkquorum
        self._zk_znode_parent = zk_znode_parent
    ...
    def connect(self):
        ...
        if len(self._conns) > 0:
            ...
            return Connection(self._on_conn_close, self._zkquorum, self._zk_znode_parent)
