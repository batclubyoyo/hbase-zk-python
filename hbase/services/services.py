...
class MasterService(Service):
    ...
    def _rebuild_request(self):
        self._host, self._port = zookeeper.get_master(self._zkquorum, zkpath=self._zkpath)
...
class MetaService(Service):
    ...
    def _rebuild_request(self):
        self._host, self._port = zookeeper.get_region(self._zkquorum, zkpath=self._zkpath)
